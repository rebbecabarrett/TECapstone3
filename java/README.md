...
1. **[COMPLETE]** As a user of the system, I need to be able to register myself with a username and password.
   ...
   2. The ability to register has been provided in your starter code and the account is set at $1000 for you (see database).
2. **[COMPLETE]** As a user of the system, I need to be able to log in using my registered username and password.
   1. Logging in returns an Authentication Token. I need to include this token with all my subsequent interactions with the system outside of registering and logging in.
   2. The ability to log in has been provided in your starter code. 
   HINT: Don't forget to find the JWT token and place it somewhere for subsequent web service calls.
